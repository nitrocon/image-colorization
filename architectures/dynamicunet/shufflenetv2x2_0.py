...
class ShuffleNetV2x2_0DynamicUnet(torch.nn.Module):
    def __init__(self, device, size=None):
        super(ShuffleNetV2x2_0DynamicUnet, self).__init__()
        self.device = device
        
        with tqdm(total=2, desc="Initializing ShuffleNetV2 X2.0 Dynamic-UNet") as pbar:
        ...
        print("ShuffleNetV2 X2.0 Dynamic-UNet model initialized and moved to device.")
